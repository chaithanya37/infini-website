	...
	return (
		<div className="w-[100%] md:min-h-[550px] flex flex-col md:flex-row items-center justify-start md:justify-center pl-[0px]">
			...
			<div className="md:w-[40%] w-[90%] min-h-[100px]">
				...
				<p className="text-[120%] font-[600] text-center md:text-left">If you're looking for cutting-edge software solutions and innovative mobile app development, you’ve come to the right place. At Infinimove, we turn your ideas into reality with technology that drives results.</p><br />
