		...
		<div className="md:w-[60%] w-[93%] h-auto m-auto md:mt-[100px] mt-[50px] flex flex-col items-center justify-start md:gap-[50px] gap-[20px]">
			...
			<div className="md:w-[80%] w-[100%] h-auto relative rounded-[15px]">
				...
				>
					...
					<div className="nextArrowNav border z-[10] w-[35px] h-[35px] bg-[white] absolute top-[50%] right-[21%] md:right-[20%] translate-y-[-50%] flex items-center justify-center rounded-[50%] cursor-pointer">
						<ArrowForwardIos sx={{ color: "black" }} />
					</div>

					<div className="prevArrowNav border z-[10] w-[35px] h-[35px] bg-[white] absolute top-[50%] left-[21%] md:left-[20%] translate-y-[-50%] flex items-center justify-center rounded-[50%] cursor-pointer">
						<ArrowBackIos sx={{ color: "black" }} />
					</div>

				</Swiper>

				<div className='absolute left-0 h-[100%] md:w-[120px] w-[100px] bg-left-feedback-linear z-[1] top-0 rounded-tr-[100%] rounded-br-[100%] rounded-tl-[15px] rounded-bl-[15px] backdrop-blur-[4px] ' >
				</div>

				<div className='absolute right-0 h-[100%] md:w-[120px] w-[100px] bg-right-feedback-linear z-[1] top-0 rounded-tl-[100%] rounded-bl-[100%] rounded-tr-[15%] rounded-br-[15%] backdrop-blur-[4px]' >
				</div>
